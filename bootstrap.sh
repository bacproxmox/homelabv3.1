...
REPO_URL="${REPO_URL:-https://github.com/bacproxmox/homelabv3.1.git}"
INSTALL_DIR="${INSTALL_DIR:-/root/homelabv3.1}"
BRANCH="${BRANCH:-main}"
BOOTSTRAP_MARKER="/root/.homelabv3.1-bootstrap-reboot-done"
export HOMELAB_VERSION="3.1"
...
if [[ -f "$current_dir/installer/tui.sh" && -f "$current_dir/bin/homelab" ]]; then
  ...
  echo "Homelab v3.1 local package bulundu; TUI baslatiliyor..."
...
echo "========================================="
echo " Homelab v3.1 - Modular Bootstrap"
...
echo
echo "[6/8] Clone/update Homelab v3.1 repo..."
...
echo
echo "[8/8] Start Homelab v3.1 TUI..."
